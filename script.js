...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function typeDescription() {
        const descriptions = [
            ...
            "رَبِّ اجْعَلْنِي مُقِيمَ الصَّلَاةِ وَمِن ذُرِّيَّتِي رَبَّنَا وَتَقَبَّلْ دُعَا",    // CHANGE THIS: Your second description
    ...
    async function buildPlaylist() {
        ...
        const potentialFiles = [
            // Your known files
            'الكهف ١٤ ١٥ القارئ مهدي الشيشاني.mp3',
            'التوبة ٧٣ القارئ مهدي الشيشاني.mp3'
        ];
    ...
    if (discordBtn) {
        discordBtn.addEventListener('click', function (e) {
            window.open(`https://discord.com/users/${846218956980486144}`, `_blank`);
        });
    }
    ...
    async function fetchDiscordActivity() {
        try {
            const response = await fetch(`https://api.lanyard.rest/v1/users/846218956980486144`);
